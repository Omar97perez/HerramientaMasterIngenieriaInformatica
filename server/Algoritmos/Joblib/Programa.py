...
if algoritmoSeleccionado == 1:
  graficaFinal = st.BR(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
elif algoritmoSeleccionado == 2:
  graficaFinal= st.DecisionTreeRegression(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
elif algoritmoSeleccionado == 3:
  graficaFinal = st.MeanShift1(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
elif algoritmoSeleccionado == 4:
  graficaFinal= st.LinearRegresion(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
  ...
  graficaFinal= st.MLPRegressorSA(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
elif algoritmoSeleccionado == 7:
  graficaFinal= st.ComparativeRegression(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
  ...
  graficaFinal= st.ComparativeClasification(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
elif algoritmoSeleccionado == 9:
  graficaFinal= st.AgglomerativeClusteringSA(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
elif algoritmoSeleccionado == 10:
  graficaFinal= st.ComparativeClustering(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
elif algoritmoSeleccionado == 11:
  graficaFinal= st.DBSCANSA(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
  ...
  # Y = iris.target
  X = (array[:,columnaSeleccionada-2:columnaSeleccionada])
  graficaFinal= st.GaussianProcessClassifierSA(X, Y, pedirParametros, nombreFichero, n_jobs_parrallel)
  graficaFinal.grafica()
else:
